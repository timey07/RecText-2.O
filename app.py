...
pasted_image = image_paste(label="", key="paste_area", max_width=600)

if uploaded_file or pasted_image:
    image = Image.open(uploaded_file) if uploaded_file else pasted_image
    ...
    st.info("Paste a screenshot or upload an image to begin.")
